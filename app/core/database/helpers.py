...
def is_unique_constraint_error(e: IntegrityError, constraint_name: str) -> bool:
    ...
    return e.orig.pgcode == UNIQUE_VIOLATION and constraint_msg in str(e)  # type: ignore
...
def is_unique_column_error(e: IntegrityError, column_name: str) -> bool:
    ...
    return e.orig.pgcode == UNIQUE_VIOLATION and f"Key ({column_name})" in str(e)  # type: ignore
