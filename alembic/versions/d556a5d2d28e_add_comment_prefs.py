...
def upgrade():
    op.add_column(
        'preferences',
        sa.Column('comment_notifications', sa.Boolean(), server_default=sa.text('true'), nullable=False)
    )
    op.add_column(
        'preferences',
...
def downgrade():
    op.add_column(
        'preferences',
        sa.Column('post_notifications', sa.Boolean(), server_default=sa.text('false'), nullable=False)
    )
